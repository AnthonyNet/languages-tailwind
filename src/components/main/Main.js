    ...
    <div className="testSection flex flex-col justify-center items-center w-full h-[100vh] border-2">
      ...
      <div className="w-[300px] h-[420px] bg-transparent cursor-pointer group perspective">
        <div className="relative preserve-3d group-hover:my-rotate-y-180 w-full h-full duration-1000">
          <div className="absolute -z-50 backface-hidden border-2 w-full h-full">
            <img
          ...
          <div className="absolute my-rotate-y-180 backface-hidden w-full h-full bg-gray-100 overflow-hidden shadow-lg shadow-gray-400">
            <div className="text-center flex flex-col items-center justify-center h-full text-gray-800 px-2 pb-24 ">
              <h1 className="text-3xl font-semibold">{myData&&myData.chartName}</h1>
             {myData&&<Table data={myData}/>}
              ...
              <h1 className="text-sm font-semibold absolute bottom-10">{myData&&myData.time.updated}</h1>
            </div>
